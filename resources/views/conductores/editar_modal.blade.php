    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle"><i class="fa-solid fa-user-plus"></i> Editar Conductor</h5>
            ...
            <div class="modal-footer">
                <button type="button" id="btn-editar-conductor" class="btn btn-primary">Editar</button>
            </div>
        </div>
    </div>
</div>